...
// @license      MIT
// ==/UserScript==
(()=>{var f=["clubs","diamonds","hearts","spades"];function G(){let e=[];for(let t=2;t<=14;t++)for(let n of f)e.push({face:n,value:t});return e}function j(e){for(let t=e.length-1;t>0;t--){let n=Math.floor(Math.random()*(t+1));[e[t],e[n]]=[e[n],e[t]]}}function C(){let e=G();return j(e),{open:e.pop(),deck:e,move:1,status:0,lastGuess:null}}function T(e){return e.move-1}function H(e){return{...e,open:e.deck[0],deck:e.deck.slice(1),move:e.move+1}}function O(e){return{...e,status:1}}function W(e){return{...e,status:2}}function I(e,t){return[e.value,t.value].includes(14)||e.value===t.value?0:e.value<t.value?-1:e.value>t.value?1:0}function S(e,t){let n=I(e.open,e.deck[0]),o=e;return n===0||n<0&&t===0||n>0&&t===1?e.deck.length===1?o=O(e):o=H(e):o=W(e),{...o,lastGuess:t}}window.location.pathname==="/gameroom/"&&document.querySelector("#center").insertAdjacentHTML("beforeend",'<center><a href="/gameroom/?game=tyranuevavu">Tyranu Evavu</a></center>');function U(e){function t(){if(e<10||e>20){if(e%10===1)return"st";if(e%10===2)return"nd";if(e%10===3)return"rd"}return"th"}return e+t()}var N="https://i.ibb.co/dLkT8hx/montage.gif",P="https://i.ibb.co/NL9khyL/back1.gif",R="https://i.ibb.co/5GM88gN/uga-jubjub.gif",Y="https://i.ibb.co/BBgTnk7/tyranu.gif",A="https://i.ibb.co/T4QnGjp/evavu.gif",x=70;function B(e){let t=e.value-2,n=f.indexOf(e.face);return(t*4+n)*x}function F(){let e,t=document.createElement("div"),n=document.createElement("div"),o=document.createElement("img"),u=document.createElement("p"),i=document.createElement("p"),p=document.createElement("img"),c=document.createElement("img"),r=document.createElement("div"),v=document.createElement("p"),g=document.createElement("fieldset"),d=document.createElement("button");n.appendChild(o),n.appendChild(c),r.appendChild(v),r.appendChild(d),t.id="tyranu-evavu",t.dataset.status="run",p.src=R,i.innerText="Uhhg Uuuuuuhhhhgggg!",d.innerText="Try again",i.classList.add("scream"),r.classList.add("summary"),u.classList.add("move"),n.classList.add("cards");function w(){c.src=P,c.style.objectPosition="initial"}function h(s,a){a.width=x,a.height=90,a.src=N,a.style.objectPosition=`-${B(s)}px 0`,a.style.objectFit="none"}function L(s,a){a.innerHTML=`Graguda Tyranu Evavu! Gedd lacka.
